...
const AboutUs = () => {
  return (
    <div className="container">
      <Typography className="title" style={{ color: "#35AFFD", fontWeight: "bold", fontFamily: "Merriweather Sans", margin: "30px", }} sx={{ fontSize: { lg: "30px", sm: "28px", xs: "20px" } }}>About Us</Typography>
